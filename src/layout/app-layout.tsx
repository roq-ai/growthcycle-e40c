...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['team-member', 'group-leader'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Group', path: '/groups', entity: 'group', service: AccessServiceEnum.PROJECT, icon: FiUsers },
    { name: 'Metrics', path: '/metrics', entity: 'metrics', service: AccessServiceEnum.PROJECT, icon: FiBarChart2 },
